@echo off
REM Run the Main class with the jars in lib\
cd /d "%~dp0"
setlocal
...
if errorlevel 1 (
    echo Java was not found. Please install Java or set JAVA_HOME before running run.bat.
    pause
    exit /b 1
)
